  ...
  document.querySelectorAll('.js-delivery-option')
    .forEach((element) => {
      element.addEventListener('click', () => {
        ...
        renderOrderSummary();//after updating the data, we re-run the code to re-generate all of the html
      });
...
renderOrderSummary();
//this time, to update the page, instead of using DOM, we are just gonna re-run all of the above code and re-generate all the html